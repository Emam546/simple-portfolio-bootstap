    ...
    return (
        <div className="pricing pt-5 pb-5 bg-section text-center">
            <div className="container">
                ...
                <div className="row">
                <div className="plan-table col-md-6 col-lg-4 ps-3 pe-3 pt-3">
                        <div className="box bg-white pt-2 pb-5">
                            <h3 className="fw-bold text-blue pt-4 mb-2">Small Business</h3>
                            <span className="text-t1 mb-5">Lorem ipsum</span>
                            <span className="bg-section text-blue fw-boldest fs-1 d-block mt-4 p-1">
                    ...
                    <div className="plan-table col-md-6 col-lg-4 ps-3 pe-3 pt-3">
                        <div className="box bg-white pt-2 pb-5">
                            ...
                            <span className="text-t1 mb-5">Lorem ipsum</span>
                            <span className="bg-red text-white fw-boldest fs-1 d-block mt-4 p-1">
